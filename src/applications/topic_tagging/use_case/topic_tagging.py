...
from src.applications.topic_tagging.application.prompt.prompt_loading import TopicTaggingPromptLoading
from src.applications.topic_tagging.application.models import TopicTagging
