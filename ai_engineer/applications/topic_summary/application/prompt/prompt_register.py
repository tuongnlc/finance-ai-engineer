from ai_engineer.applications.topic_summary.application.prompt.prompt_template import business_template, macro_template, market_template, fund_template, law_template
