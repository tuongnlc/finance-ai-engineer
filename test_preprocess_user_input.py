...
preprocess_user_input_template = [
    {
        ...
        "content": (
            ...
            "1. **Phân loại câu hỏi của user (query_classification). Luôn luôn trả về các kết quả như bên dưới**\n"
            ...
            "2. **Phân loại nội dung câu hỏi (content_classification). Luôn luôn trả về các kết quả như bên dưới**\n"
            ...
            "CHỈ TRẢ VỀ JSON THUẦN TÚY, KHÔNG sử dụng markdown code block (không có ```json hay ``` bao bọc).\n"
            "{{\n"
