...
messages = [
    {
        "role": "system",
        "content": "[PERSONA] Bạn là một chuyên gia tài chính chuyên phân tích và trích xuất thông tin QUỸ VÀ DANH MỤC ĐẦU TƯ từ các bài báo để phân tích sự ảnh hưởng tới thị trường chứng khoán. \n"
